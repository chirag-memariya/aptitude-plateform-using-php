<?php
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['demail'] && $_SESSION['key']=='admin')
    {
      ...
      echo "<center><h3><script>alert('Error while deleting a User!!');</script></h3></center>";
      header("location:dashboard.php?q=1");
    }
  }

  else{
    echo "<center><h3><script>alert('Error while deleting a User!!(please login as admin)');</script></h3></center>";
      header("location:dashboard.php?q=1");
  }
